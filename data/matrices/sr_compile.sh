...
csv_dir="/ZPOOL/data/projects/istart-mel/data/matrices/all_sharedreward_mats"

# Iterate over each region
for region in "${regions[@]}"; do
    # Create an empty output file for the region
    output_file="/ZPOOL/data/projects/istart-mel/data/matrices/all_sharedreward_${region}_mat.csv"
