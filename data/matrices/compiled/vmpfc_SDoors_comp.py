...
def write_csv(data, output_file):
    with open(output_file, 'w', newline='') as csvfile:
        fieldnames = ['sub_id', 'soc_win', 'soc_loss']
...
def main():
    source_csv = '/ZPOOL/data/projects/istart-mel/data/matrices/all_socdoors_mats/all_socdoors_vmpfc_mat.csv'
    output_csv = 'vmpfc_SOCDOORS_COMP_mat.csv'
