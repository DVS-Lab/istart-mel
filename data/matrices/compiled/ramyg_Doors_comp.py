...
def write_csv(data, output_file):
    with open(output_file, 'w', newline='') as csvfile:
        fieldnames = ['sub_id', 'door_win', 'door_loss']
...
def main():
    source_csv = '/ZPOOL/data/projects/istart-mel/data/matrices/all_socdoors_mats/all_doors_ramyg_mat.csv'
    output_csv = 'ramyg_DOORS_COMP_mat.csv'
