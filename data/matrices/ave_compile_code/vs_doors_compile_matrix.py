...
data_dir = '/ZPOOL/data/projects/istart-mel/data/socialdoors/vs_doors'
...
for subject_id in subjects_to_include:
    ...
    for idx, zstat_type in enumerate(zstat_order, start=1):
        filename = f'sub-{subject_id}_doors_zstat{idx}.txt'
...
data_df.to_csv('vs_doors_matrix.csv', index=False)

print("Data saved as 'vs_doors_matrix.csv'.")
